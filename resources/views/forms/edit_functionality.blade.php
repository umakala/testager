...
@section('content')
<form action="{{URL::route('functionality.update', ['id' => $functionality->tf_id])}}" method ="POST" class="form-horizontal" enctype='multipart/form-data' >
<input type="hidden" name="_method" value="PUT">
<div class="wrapper" style="">
       <div class="panel panel-default" style=" padding-top:20px">
         <div class="panel-title" style="text-align: center;">Update Functionality</div>
         <hr/>
        ...
        <div class="col-sm-12 col-lg-12">                          
                ...
                <div class="form-group"> 
                    ...
                    <div class="col-xs-8">            
                       <input type="text" class="form-control" value="{{$functionality->tf_name}}" id="name"  name="name" placeholder="">
               ...
               <div class="form-group">                
                 ...
                 <div class="col-xs-8">            
                   <textarea class="form-control"  name="description"  rows="4" >{{$functionality->description}}</textarea>
